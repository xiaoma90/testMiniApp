  ...
  Formbuilder = (function() {
    ...
    Formbuilder.options = {
      ...
      mappings: {
        ...
        MAXPIC: 'field_options.maxpic',
        LENGTH_UNITS: 'field_options.min_max_length_units'
      },
      dict: {
        ALL_CHANGES_SAVED: '已保存所有改动',
        SAVE_FORM: '保存表单',
        UNSAVED_CHANGES: '您有未保存的更改。如果您离开此页面，您将丢失这些更改！'
      }
    };
...
(function() {
  var path = document.getElementById('static_root').value
  Formbuilder.registerField('多选', {
    order: 10,
    view: "<div class='box_check'> <% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n  <div class='radio_check'>\n    <label class='fb-option'>\n      <input type='checkbox' <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'checked' %> onclick=\"javascript: return false;\" />\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </label>\n  </div>\n<% } %>\n\n </div>",
    edit: "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
    addButton: "<img src='"+path+"/diyform/checkbox.png'><div class=\"symbol\">多选</div>",
...
(function() {
  ...
  Formbuilder.registerField('日期', {
    order: 20,
    view: "<div class='input-line'>\n  <span class='above-line'> <label>年</label> </span> <span class='above-line'>-</span> <span class='above-line'> <label>月</label> </span> <span class='above-line'>-</span> <span class='above-line'> <label>日</label> </span> \n</div>",
    edit: "",
    addButton: "<img src='"+path+"/diyform/date.png'><div class=\"symbol\">日期</div>"
  });
...
(function() {
  var path = document.getElementById('static_root').value
  Formbuilder.registerField('下拉选', {
    order: 24,
    view: "<select>\n  <% if (rf.get(Formbuilder.options.mappings.INCLUDE_BLANK)) { %>\n    <option value=''></option>\n  <% } %>\n\n  <% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n    <option <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'selected' %>>\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </option>\n  <% } %>\n</select>",
    edit: "<%= Formbuilder.templates['edit/options']({ includeBlank: true }) %>",
    addButton: "<img src='"+path+"/diyform/dropdown.png'><div class=\"symbol\">下拉选</div>",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
          label: "",
...
(function() {
  var path = document.getElementById('static_root').value
  Formbuilder.registerField('身份证', {
    order: 40,
    view: "<span class='help-block'>请输入<%= rf.get(Formbuilder.options.mappings.LABEL) %><span>",
    edit: "",
    addButton: "<img src='"+path+"/diyform/id.png'><div class=\"symbol\">身份证</div>"
  });
...
(function() {
  var path = document.getElementById('static_root').value
  Formbuilder.registerField('手机号', {
    order: 30,
    view: "<span class='help-block'>请输入<%= rf.get(Formbuilder.options.mappings.LABEL) %><span>",
    edit: "",
    addButton: "<img src='"+path+"/diyform/phone.png'><div class=\"symbol\">手机号</div>"
  });
...
(function() {
  ...
  Formbuilder.registerField('多行文本', {
    ...
    addButton: "<img src='"+path+"/diyform/textarea.png'><div class=\"symbol\">多行文本</div>",
    defaultAttributes: function(attrs) {
...
(function() {
  var path = document.getElementById('static_root').value
  Formbuilder.registerField('单选', {
    order: 15,
    view: "<div class='box_check'> <% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n     <div class='radio_check'>\n <label class='fb-option'>\n      <input type='radio' <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'checked' %> onclick=\"javascript: return false;\" />\n   <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n  </label>\n  </div>\n<% } %>\n\n</div>",
    edit: "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
    addButton: "<img src='"+path+"/diyform/radio.png'><div class=\"symbol\">单选</div>",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
          label: "",
...
(function() {
  ...
  Formbuilder.registerField('单行文本', {
    ...
    edit: "",
    // edit: "<%= Formbuilder.templates['edit/min_max_length']() %>",
    addButton: "<img src='"+path+"/diyform/text.png'><div class='symbol'>单行文本</div>",
    defaultAttributes: function(attrs) {
      attrs.field_options.size = 'small';
      return attrs;
    }
...
(function() {
  ...
  Formbuilder.registerField('时间', {
    order: 25,
    view: "<div class='input-line'>\n  <span class='above-line'> <label>时</label> </span> <span class='above-line'>:</span> <span class='above-line'> <label>分</label> </span> <span class='above-line'>:</span> \n</div>",
    edit: "",
    addButton: "<img src='"+path+"/diyform/time.png'><div class=\"symbol\">时间</div>"
  });
...
(function() {
  var path = document.getElementById('static_root').value
  Formbuilder.registerField('图片', {
    order: 35,
    view: "<div >\n <img class='add-img' src='"+path+"/diyform/add-img.png'>\n </div>",
    edit: "<%= Formbuilder.templates['edit/max_picnumber']() %>",
    addButton: "<img src='"+path+"/diyform/pic.png'><div class=\"symbol\">图片</div> ",
    defaultAttributes: function(attrs) {
      attrs.field_options.maxpic = "1";
      return attrs;
    }
  });
}).call(this);
...
this["Formbuilder"]["templates"]["edit/common"] = function(obj) {
  ...
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<div class=\'fb-edit-section-header\'>内容</div>\n\n<div class=\'fb-common-wrapper\'>\n  <div class=\'fb-label-description\'>\n    ' +
...
this["Formbuilder"]["templates"]["edit/label_description"] = function(obj) {
  ...
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<input onkeyup="JavaScript:replaceLikeVal(this)" type=\'text\' data-rv-input=\'model.' +
        ((__t = ( Formbuilder.options.mappings.LABEL )) == null ? '' : __t) +
        '\' />\n';
...
this["Formbuilder"]["templates"]["edit/min_max_length"] = function(obj) {
  ...
  with (obj) {
    __p += '<div class=\'fb-edit-section-header\'>长度限制</div>\n\n最少\n<input type="text" data-rv-input="model.' +
        ...
        '" style="width: auto;">\n  <option value="characters">字符</option>\n  <option value="words">文本</option>\n</select>\n';
  }
  return __p
};

this["Formbuilder"]["templates"]["edit/max_picnumber"] = function(obj) {
  obj || (obj = {});
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<div class=\'fb-edit-section-header\'><span style="color:red">*</span> 最多张数</div>\n\n最多\n<input onkeyup="JavaScript:inputNum(this)" type="text" data-rv-input="model.' +
        ((__t = ( Formbuilder.options.mappings.MAXPIC )) == null ? '1' : __t) +
        '"style="width: 30px" /><span style="margin-left:5px;">张<span>\n';
  }
  return __p
};
...
//  } ;
    __p += '\n\n<div class=\'option\' data-rv-each-option=\'model.' +
        ...
        '\'>\n  <input onkeyup="JavaScript:replaceLikeVal(this)" type="text" data-rv-input="option:label" class=\'option-label-input\' placeholder=\'选项\'/>\n  <a class="js-add-option ' +
        // '\'>\n  <input type="checkbox" class=\'js-default-updated\' data-rv-checked="option:checked" />\n  <input type="text" data-rv-input="option:label" class=\'option-label-input\' />\n  <a class="js-add-option ' +
        ((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
        '" title="Add Option"><i class=\'fa wb-plus\'></i></a>\n  <a class="js-remove-option ' +
        ((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
        '" title="Remove Option"><i class=\'fa wb-minus\'></i></a>\n</div>\n\n';
...
this["Formbuilder"]["templates"]["page"] = function(obj) {
  ...
  with (obj) {
    __p +=
        ...
        // '\n' +
        // ((__t = ( Formbuilder.templates['partials/right_form']() )) == null ? '' : __t) +
        '\n<div class=\'fb-clear\'></div>';
...
this["Formbuilder"]["templates"]["partials/left_side"] = function(obj) {
  ...
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<div class=\'fb-left\'>\n  <ul class=\'fb-tabs\'>\n    <li class=\'active\'><a data-target=\'#addField\'>表单组件</a></li>\n    <li><a data-target=\'#editField\'>组件设置</a></li>\n  </ul>\n\n  <div class=\'fb-tab-content\'>\n    ' +
...
this["Formbuilder"]["templates"]["partials/right_side"] = function(obj) {
  ...
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<div class=\'fb-right\'>\n  <div class=\'fb-no-response-fields\'>No response fields</div>\n  <div class=\'fb-bg\'> <div class=\'fb-bg-top\' style=\'background: url('+path+'/diyform/bg-top.png) top center no-repeat\'><div class=\'fb-bg-text\'>万能表单</div></div>\n <div class=\'fb-response-fields\'></div>\n</div>\n</div>\n';
...
// this["Formbuilder"]["templates"]["partials/right_form"] = function(obj) {
// obj || (obj = {});
// var __t, __p = '', __e = _.escape;
// with (obj) {
// __p += '<div class=\'fb-right-form\'>\n  <div class=\'form-box\'> <div class=\'form-text\'><div class=\'form-maketext\'>基础设置</div></div>\n <div class=\'form-inputsname\'>表单名称 <input type=\'text\' name=\'formtitle\'><span class=\'form-tishi\'>后台表单名称</span></div>\n <div class=\'form-inputsname\'>表单标题 <input type=\'text\'  name=\'formname\'><span class=\'form-tishi\'>小程序端标题，不填则不显示</span></div>\n <div class=\'form-inputsname\'>表单说明 <textarea class=\'shuom-texts\' type=\'text\' name=\'descs\'></textarea> </div>\n </div>\n </div>\n';
// }
// return __p
// };
...
this["Formbuilder"]["templates"]["view/duplicate_remove"] = function(obj) {
  ...
  with (obj) {
    __p += '<div class=\'actions-wrapper\'>\n  <a class="js-duplicate ' +
        ((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
        '" title="Duplicate Field"><i class=\' fa wb-plus\'></i></a>\n  <a class="js-clear ' +
        ((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
        '" title="Remove Field"><i class=\'fa wb-minus\'></i></a>\n</div>';
...
this["Formbuilder"]["templates"]["view/label"] = function(obj) {
  ...
  with (obj) {
    ...
    if (rf.get(Formbuilder.options.mappings.REQUIRED)) { ;
      __p += '\n    <span class="s-required" title=\'required\'>*</span>\n  ';
    } ;
    __p += '\n</label>\n';
...
function inputNum(num){
  num.value = num.value.replace(/^(0+)|[^\d]+/g,'')
}
