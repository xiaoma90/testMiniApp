! function(e, t) {
	...
	function n(e) {
		var n = [];
		return s(n, t.noop).chars(e), n.join("")
	}
	...
	function o(e) {
		return e.replace(/&/g, "&amp;").replace(u, function(e) {
	...
	function s(e, n) {
		...
		return {
			start: function(e, a) {
				e = t.lowercase(e), !r && y[e] && (r = e), r || !0 !== k[e] || (i("<"), i(e), t.forEach(a, function(r, a) {
					var s = t.lowercase(a),
						l = "img" === e && "src" === s || "background" === s;
					!0 !== z[s] || !0 === w[s] && !n(r, l) || (i(" "), i(a), i('="'), i(o(r)), i('"'))
				}), i(">"))
			},
			end: function(e) {
				e = t.lowercase(e), r || !0 !== k[e] || !0 === p[e] || (i("</"), i(e), i(">")), e == r && (r = !1)
			},
			chars: function(e) {
				r || i(o(e))
			}
	...
	function l(t) {
		...
		var s = t.firstChild;
		s && l(s), (s = t.nextSibling) && l(s)
	}
	var c, d = t.$$minErr("$sanitize"),
		u = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
		h = /([^\#-~ |!])/g,
		p = r("area,br,col,hr,img,wbr"),
		f = r("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"),
		m = r("rp,rt"),
		g = t.extend({}, m, f),
		b = t.extend({}, f, r("address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,section,table,ul")),
		v = t.extend({}, m, r("a,abbr,acronym,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,q,ruby,rp,rt,s,samp,small,span,strike,strong,sub,sup,time,tt,u,var")),
		x = r("circle,defs,desc,ellipse,font-face,font-face-name,font-face-src,g,glyph,hkern,image,linearGradient,line,marker,metadata,missing-glyph,mpath,path,polygon,polyline,radialGradient,rect,stop,svg,switch,text,title,tspan"),
		y = r("script,style"),
		k = t.extend({}, p, b, v, g),
		w = r("background,cite,href,longdesc,src,xlink:href"),
		C = r("abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,coords,dir,face,headers,height,hreflang,hspace,ismap,lang,language,nohref,nowrap,rel,rev,rows,rowspan,rules,scope,scrolling,shape,size,span,start,summary,tabindex,target,title,type,valign,value,vspace,width"),
	...
	! function(e) {
		...
		if(1 === n.length) c = n[0];
			...
			c = t.createElement("body"), r.appendChild(c), t.appendChild(r)
		}
	}(e), t.module("ngSanitize", []).provider("$sanitize", function() {
		var e = !1;
		this.$get = ["$$sanitizeUri", function(n) {
			return e && t.extend(k, x),
				function(e) {
					var t = [];
					return i(e, s(t, function(e, t) {
		...
		var r = /((ftp|https?):\/\/|(www\.)|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"\u201d\u2019]/i,
			i = /^mailto:/i,
			a = t.$$minErr("linky"),
			o = t.isString;
		return function(s, l, c) {
			...
			for(var u, h, p, f = s, m = []; u = f.match(r);) h = u[0], u[2] || u[4] || (h = (u[3] ? "http://" : "mailto:") + h), p = u.index, d(f.substr(0, p)),
				function(e, n) {
					var r;
					if(m.push("<a "), t.isFunction(c) && (c = c(e)), t.isObject(c))
						for(r in c) m.push(r + '="' + c[r] + '" ');
					else c = {};
					!t.isDefined(l) || "target" in c || m.push('target="', l, '" '), m.push('href="', e.replace(/"/g, "&quot;"), '">'), d(n), m.push("</a>")
				}(h, u[0].replace(i, "")), f = f.substring(p + u[0].length);
			return d(f), e(m.join(""))
		}
	}])
