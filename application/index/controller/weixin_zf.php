    ...
    class WxpayService extends Controller
    {
        ...
        {   
            ...
            if ($unifiedOrder === false) {
                die('请检查分销->分销提现管理->提现设置');
            }
            if ($unifiedOrder->return_code != 'SUCCESS') {
                die($unifiedOrder->return_msg);
            }
            if ($unifiedOrder->result_code != 'SUCCESS') {
                if($unifiedOrder->err_code == "NOTENOUGH"){
                    die("您的付款帐号余额不足或资金未到账");
                }else if($unifiedOrder->err_code == "NO_AUTH"){
                    die("没有该接口权限");
                }else if($unifiedOrder->err_code == "AMOUNT_LIMIT"){
                    die("金额超限");
                }else if($unifiedOrder->err_code == "PARAM_ERROR"){
                    die("参数错误");
                }else{
        ...
        {   
            ...
            curl_setopt($ch,CURLOPT_SSLCERT,ROOT_PATH.'public/Cert/'.$uniacid.'/apiclient_cert.pem');
            //默认格式为PEM，可以注释
            curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
            curl_setopt($ch,CURLOPT_SSLKEY,ROOT_PATH.'public/Cert/'.$uniacid.'/apiclient_key.pem');
