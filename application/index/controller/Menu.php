...
class Menu extends Base
{
    public function index(){
        if(check_login()){
        	if(powerget()){
                ...
                $cate = Db::name('wd_xcx_cate')->where("uniacid",$appletid)->order('num desc')->select();
    ...
    public function newfoot(){
        if(check_login()){
            if(powerget()){
                ...
                $this->assign('applet',$res);
                $item = Db::name('wd_xcx_base')->where("uniacid",$appletid)->find();
                if(!$item){
                    $this->error('请先设置基础信息！');
                }
    ...
    public function savenew(){
            ...
            if(input('tabbar1')==2){
                ...
                if($tabimginput1_1){
                    $tabbar1['tabimginput_1'] = remote($appletid, $tabimginput1_1,2);
                }
                $tabbar1['tabimginput_2']= '';
                $tabimginput1_2 = input("commonuploadpic2");
                if($tabimginput1_2){
                    $tabbar1['tabimginput_2'] = remote($appletid, $tabimginput1_2,2);
                }
            }
            ...
            if(input('tabbar2')==2){
                ...
                if($tabimginput2_1){
                    $tabbar2['tabimginput_1'] = remote($appletid, $tabimginput2_1,2);
                }

                $tabbar2['tabimginput_2']= '';
                $tabimginput2_2 = input("commonuploadpic4");
                if($tabimginput2_2){
                    $tabbar2['tabimginput_2'] = remote($appletid, $tabimginput2_2,2);
                }
            }
            ...
            if(input('tabbar3') ==2){
                ...
                if($tabimginput3_1){
                    $tabbar3['tabimginput_1'] = remote($appletid, $tabimginput3_1,2);
                }

                $tabbar3['tabimginput_2']= '';
                $tabimginput3_2 = input("commonuploadpic6");
                if($tabimginput3_2){
                    $tabbar3['tabimginput_2'] = remote($appletid, $tabimginput3_2,2);
                }
            }
            ...
            if(input('tabbar4')==2){
                ...
                if($tabimginput4_1){
                    $tabbar4['tabimginput_1'] = remote($appletid, $tabimginput4_1,2);
                }
                $tabbar4['tabimginput_2']= '';
                $tabimginput4_2 = input("commonuploadpic8");
                if($tabimginput4_2){
                    $tabbar4['tabimginput_2'] = remote($appletid, $tabimginput4_2,2);
                }
            }
            ...
            if(input('tabbar5')==2){
                ...
                if($tabimginput5_1){
                    $tabbar5['tabimginput_1'] = remote($appletid, $tabimginput5_1,2);
                }
                $tabbar5['tabimginput_2']= '';                
                $tabimginput5_2 = input("commonuploadpic-10");
                if($tabimginput5_2){
                    $tabbar5['tabimginput_2'] = remote($appletid, $tabimginput5_2,2);
                }
            }
